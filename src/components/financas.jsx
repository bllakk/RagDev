...
export default function Financas() {
    ...
    const fetchExpenses = async () => {
        setLoading(true);
        try {
            const response = await axios.get('http://localhost:3001/bankEspenseResult', { withCredentials: true });
    ...
    const fetchGanhosMes = async () => {
        ...
        setError(null);
        try {
            const response = await axios.get('http://localhost:3001/bankResult', { withCredentials: true });
    ...
    const expenses = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3001/bankExpenses', { ganho: expenseNum, nameExpense }, { withCredentials: true });
    ...
    const deposit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3001/bankDeposit', { ganho: ganhoNum }, { withCredentials: true });
